...
umain(int argc, char **argv)
{
  ...
  80003f:	68 e4 0d 80 00       	push   $0x800de4
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80018c:	e8 cf 09 00 00       	call   800b60 <__udivdi3>
  ...
  8001cf:	e8 bc 0a 00 00       	call   800c90 <__umoddi3>
  8001d4:	83 c4 14             	add    $0x14,%esp
  8001d7:	0f be 80 0c 0e 80 00 	movsbl 0x800e0c(%eax),%eax
  8001de:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800299:	ff 24 85 9c 0e 80 00 	jmp    *0x800e9c(,%eax,4)
  ...
  80035b:	83 f8 06             	cmp    $0x6,%eax
  80035e:	7f 0b                	jg     80036b <vprintfmt+0x145>
  800360:	8b 14 85 f4 0f 80 00 	mov    0x800ff4(,%eax,4),%edx
  800367:	85 d2                	test   %edx,%edx
  800369:	75 1b                	jne    800386 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  80036b:	50                   	push   %eax
  80036c:	68 24 0e 80 00       	push   $0x800e24
  800371:	53                   	push   %ebx
  800372:	56                   	push   %esi
  ...
  800386:	52                   	push   %edx
  800387:	68 2d 0e 80 00       	push   $0x800e2d
  80038c:	53                   	push   %ebx
  80038d:	56                   	push   %esi
  ...
  8003b1:	b8 1d 0e 80 00       	mov    $0x800e1d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ad9:	68 10 10 80 00       	push   $0x801010
  800ade:	6a 23                	push   $0x23
  800ae0:	68 2d 10 80 00       	push   $0x80102d
  800ae5:	e8 27 00 00 00       	call   800b11 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b15:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800b16:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800b19:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800b1f:	e8 ce ff ff ff       	call   800af2 <sys_getenvid>
  800b24:	83 ec 0c             	sub    $0xc,%esp
  800b27:	ff 75 0c             	pushl  0xc(%ebp)
  800b2a:	ff 75 08             	pushl  0x8(%ebp)
  800b2d:	56                   	push   %esi
  800b2e:	50                   	push   %eax
  800b2f:	68 3c 10 80 00       	push   $0x80103c
  800b34:	e8 f0 f5 ff ff       	call   800129 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800b39:	83 c4 18             	add    $0x18,%esp
  800b3c:	53                   	push   %ebx
  800b3d:	ff 75 10             	pushl  0x10(%ebp)
  800b40:	e8 93 f5 ff ff       	call   8000d8 <vcprintf>
	cprintf("\n");
  800b45:	c7 04 24 00 0e 80 00 	movl   $0x800e00,(%esp)
  800b4c:	e8 d8 f5 ff ff       	call   800129 <cprintf>
  800b51:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800b54:	cc                   	int3   
  800b55:	eb fd                	jmp    800b54 <_panic+0x43>
