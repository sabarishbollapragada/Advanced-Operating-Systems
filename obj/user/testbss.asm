...
umain(int argc, char **argv)
{
  ...
  800039:	68 74 0e 80 00       	push   $0x800e74
  ...
  800055:	50                   	push   %eax
  800056:	68 ef 0e 80 00       	push   $0x800eef
  80005b:	6a 11                	push   $0x11
  80005d:	68 0c 0f 80 00       	push   $0x800f0c
...
umain(int argc, char **argv)
{
  ...
  800095:	50                   	push   %eax
  800096:	68 94 0e 80 00       	push   $0x800e94
  80009b:	6a 16                	push   $0x16
  80009d:	68 0c 0f 80 00       	push   $0x800f0c
  ...
  8000b4:	68 bc 0e 80 00       	push   $0x800ebc
  ...
  8000cb:	68 1b 0f 80 00       	push   $0x800f1b
  8000d0:	6a 1a                	push   $0x1a
  8000d2:	68 0c 0f 80 00       	push   $0x800f0c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800140:	56                   	push   %esi
  800141:	50                   	push   %eax
  800142:	68 3c 0f 80 00       	push   $0x800f3c
  ...
  800153:	e8 54 00 00 00       	call   8001ac <vcprintf>
	cprintf("\n");
  800158:	c7 04 24 0a 0f 80 00 	movl   $0x800f0a,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800260:	e8 8b 09 00 00       	call   800bf0 <__udivdi3>
  ...
  8002a3:	e8 78 0a 00 00       	call   800d20 <__umoddi3>
  8002a8:	83 c4 14             	add    $0x14,%esp
  8002ab:	0f be 80 60 0f 80 00 	movsbl 0x800f60(%eax),%eax
  8002b2:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80036d:	ff 24 85 f0 0f 80 00 	jmp    *0x800ff0(,%eax,4)
  ...
  800434:	8b 14 85 48 11 80 00 	mov    0x801148(,%eax,4),%edx
  80043b:	85 d2                	test   %edx,%edx
  80043d:	75 1b                	jne    80045a <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  80043f:	50                   	push   %eax
  800440:	68 78 0f 80 00       	push   $0x800f78
  800445:	53                   	push   %ebx
  800446:	56                   	push   %esi
  ...
  80045a:	52                   	push   %edx
  80045b:	68 81 0f 80 00       	push   $0x800f81
  800460:	53                   	push   %ebx
  800461:	56                   	push   %esi
  ...
  800485:	b8 71 0f 80 00       	mov    $0x800f71,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bad:	68 64 11 80 00       	push   $0x801164
  800bb2:	6a 23                	push   $0x23
  800bb4:	68 81 11 80 00       	push   $0x801181
