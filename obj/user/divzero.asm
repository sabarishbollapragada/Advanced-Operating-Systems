...
umain(int argc, char **argv)
{
  ...
  800050:	50                   	push   %eax
  800051:	68 f4 0d 80 00       	push   $0x800df4
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80019e:	e8 cd 09 00 00       	call   800b70 <__udivdi3>
  ...
  8001e1:	e8 ba 0a 00 00       	call   800ca0 <__umoddi3>
  8001e6:	83 c4 14             	add    $0x14,%esp
  8001e9:	0f be 80 0c 0e 80 00 	movsbl 0x800e0c(%eax),%eax
  8001f0:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002ab:	ff 24 85 9c 0e 80 00 	jmp    *0x800e9c(,%eax,4)
  ...
  80036d:	83 f8 06             	cmp    $0x6,%eax
  800370:	7f 0b                	jg     80037d <vprintfmt+0x145>
  800372:	8b 14 85 f4 0f 80 00 	mov    0x800ff4(,%eax,4),%edx
  800379:	85 d2                	test   %edx,%edx
  80037b:	75 1b                	jne    800398 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  80037d:	50                   	push   %eax
  80037e:	68 24 0e 80 00       	push   $0x800e24
  800383:	53                   	push   %ebx
  800384:	56                   	push   %esi
  ...
  800398:	52                   	push   %edx
  800399:	68 2d 0e 80 00       	push   $0x800e2d
  80039e:	53                   	push   %ebx
  80039f:	56                   	push   %esi
  ...
  8003c3:	b8 1d 0e 80 00       	mov    $0x800e1d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800aeb:	68 10 10 80 00       	push   $0x801010
  800af0:	6a 23                	push   $0x23
  800af2:	68 2d 10 80 00       	push   $0x80102d
  800af7:	e8 27 00 00 00       	call   800b23 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b31:	e8 ce ff ff ff       	call   800b04 <sys_getenvid>
  800b36:	83 ec 0c             	sub    $0xc,%esp
  800b39:	ff 75 0c             	pushl  0xc(%ebp)
  800b3c:	ff 75 08             	pushl  0x8(%ebp)
  800b3f:	56                   	push   %esi
  800b40:	50                   	push   %eax
  800b41:	68 3c 10 80 00       	push   $0x80103c
  800b46:	e8 f0 f5 ff ff       	call   80013b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800b4b:	83 c4 18             	add    $0x18,%esp
  800b4e:	53                   	push   %ebx
  800b4f:	ff 75 10             	pushl  0x10(%ebp)
  800b52:	e8 93 f5 ff ff       	call   8000ea <vcprintf>
	cprintf("\n");
  800b57:	c7 04 24 00 0e 80 00 	movl   $0x800e00,(%esp)
  800b5e:	e8 d8 f5 ff ff       	call   80013b <cprintf>
  800b63:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800b66:	cc                   	int3   
  800b67:	eb fd                	jmp    800b66 <_panic+0x43>
