	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d7:	0f be 80 15 0e 80 00 	movsbl 0x800e15(%eax),%eax
  8001de:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800299:	ff 24 85 a4 0e 80 00 	jmp    *0x800ea4(,%eax,4)
  ...
  800360:	8b 14 85 fc 0f 80 00 	mov    0x800ffc(,%eax,4),%edx
  800367:	85 d2                	test   %edx,%edx
  800369:	75 1b                	jne    800386 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  80036b:	50                   	push   %eax
  80036c:	68 2d 0e 80 00       	push   $0x800e2d
  800371:	53                   	push   %ebx
  800372:	56                   	push   %esi
  ...
  800386:	52                   	push   %edx
  800387:	68 36 0e 80 00       	push   $0x800e36
  80038c:	53                   	push   %ebx
  80038d:	56                   	push   %esi
  ...
  8003b1:	b8 26 0e 80 00       	mov    $0x800e26,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ad9:	68 18 10 80 00       	push   $0x801018
  800ade:	6a 23                	push   $0x23
  800ae0:	68 35 10 80 00       	push   $0x801035
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b2d:	56                   	push   %esi
  800b2e:	50                   	push   %eax
  800b2f:	68 44 10 80 00       	push   $0x801044
  ...
  800b40:	e8 93 f5 ff ff       	call   8000d8 <vcprintf>
	cprintf("\n");
  800b45:	c7 04 24 68 10 80 00 	movl   $0x801068,(%esp)
